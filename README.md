...
│       └── generate.yml          # CI: auto-regenerate README on push
├── docs/
...
│   └── generate_readme.py       # Auto-generate README sections
...
Scans all `metadata.json` files and updates the auto-generated sections in this
README (statistics, topics, solved table, recent activity, language breakdown).
Idempotent — safe to run repeatedly. CI auto-regenerates on push

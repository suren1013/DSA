...
│       └── generate.yml          # CI: auto-regenerate README & dashboard on push
...
and updates the auto-generated dashboard sections in this README plus the
`dashboard/stats.json` file. Idempotent — safe to run repeatedly. CI
auto-regenerates both on push (`.github/workflows/generate.yml`).
